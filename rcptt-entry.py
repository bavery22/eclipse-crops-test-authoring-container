...
parser.add_argument('--args', nargs=argparse.REMAINDER,
                    help='Any remaining arguments are passed to the Eclipse launcher. '
                    )
...
cmd = """usersetup.py --username=rcpttuser --workdir={wd} {idargs}
         rcptt-launch.sh {wd} {prj} {rcpttargs}""".format(wd=args.workdir, idargs=idargs, prj=args.project, rcpttargs=rcpttargs )
cmd = cmd.split()
os.execvp(cmd[0], cmd)
#print cmd
